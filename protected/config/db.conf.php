...
$dbmap['Event']['has_one']['Category'] = array('foreign_key'=>'category_id');

$dbconfig['dev'] = array('localhost', 'localwall', 'root', 'root123', 'mysql', true);
$dbconfig['slave'] = array('localhost', 'localwall', 'root', '', 'mysql', true);
//$dbconfig['list'] = false;
